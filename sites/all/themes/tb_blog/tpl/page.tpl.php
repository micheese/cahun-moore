...
<!--              <img src="--><?php //print $logo; ?><!--" alt="--><?php //print t('Home'); ?><!--" />-->
  ...
  <!-- //HEADER -->
    ...
    <div id="slideshow-wrapper" class="wrapper">
      <div class="container">
          <div id="slides">
              <img src="/sites/default/files/images/slider/slide1.jpg" alt="Claude Cahun - Marcel Moore" style="max-width: 100%;max-height: 100%">
              <img src="/sites/default/files/images/slider/slide4.jpg" alt="Claude Cahun - Marcel Moore" style="max-width: 100%;max-height: 100%">
              <img src="/sites/default/files/images/slider/slide3.jpg" alt="Claude Cahun - Marcel Moore" style="max-width: 100%;max-height: 100%">
              <img src="/sites/default/files/images/slider/slide5.jpg" alt="Claude Cahun - Marcel Moore" style="max-width: 100%;max-height: 100%">
              <img src="/sites/default/files/images/slider/slide2.jpg" alt="Claude Cahun - Marcel Moore" style="max-width: 100%;max-height: 100%">
          </div>
